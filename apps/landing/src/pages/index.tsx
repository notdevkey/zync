...
export function Index() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <h1 className="mb-6 text-6xl font-medium text-center text-white">
        Ultimate type safety, <br /> synced all across your application.
      </h1>

      <p className="text-center text-[#BABDC0] font-dm-sans font-medium mix-blend-color-dodge max-w-3xl">
      ...
      <div className="absolute flex flex-col items-center text-white bottom-20">
